...
import {InstanceDownloadableInterface, InstanceInterface, InstanceServiceInterface} from '../../persistence/interface/instance.interface';
...
export class DownloadableController {
        ...
        res
            ...
            .set({
                ...
                'Content-Disposition': contentDisposition(
                    `downloadable-${instance.hash}-${downloadable.id}-${moment().format('YmdHis')}.tar`,
                ),
            });

        spawnedDockerCopy.stdout.pipe(res);
        spawnedDockerCopy.stderr.pipe(res); // TODO Handle error differently.
    }
    ...
    protected findDownloadable(downloadableId: string, instance: InstanceInterface): InstanceDownloadableInterface | null {
    ...
    protected findService(serviceId: string, instance: InstanceInterface): InstanceServiceInterface | null {
