...
export class DeployKeyResolverFactory {
    ...
    ): (object: object, args: object) => Promise<DeployKeyTypeInterface[]> {
        return async (
            object: object,
            args: object,
    ...
    getItemFingerprintResolver(): (
        object: DeployKeyInterface,
        args: object,
    ) => Promise<string> {
        return async (
            object: DeployKeyInterface,
    ...
    getRegenerateItemResolver(): (
        obj: any,
        regenerateDeployKeyInput: RegenerateDeployKeyInputTypeInterface,
    ) => Promise<DeployKeyTypeInterface> {
        return async (
            obj: any,
            regenerateDeployKeyInput: RegenerateDeployKeyInputTypeInterface,
    ...
    getGenerateMissingItemsResolver(): (
        obj: any,
        regenerateDeployKeyInput: RegenerateDeployKeyInputTypeInterface,
    ) => Promise<object> {
        return async (
            ...
            for (const referencedCloneUrl of referencedCloneUrls) {
                createPromises.push(
                    this.deployKeyRepository.create(referencedCloneUrl),
                );
            }
    ...
    getRemoveItemResolver(): (
        obj: any,
        removeDeployKeyInput: RemoveDeployKeyInputTypeInterface,
    ) => Promise<object> {
        return async (
            obj: any,
            removeDeployKeyInput: RemoveDeployKeyInputTypeInterface,
        ): Promise<object> => {
            await this.deployKeyRepository.remove(
