    ...
    protected createResolvers(): any {
        return {
            ...
            Mutation: {
                ...
                modifyInstance: this.instanceResolverFactory.getModifyItemResolver(),
            ...
            Definition: {
                project: this.projectsResolverFactory.getItemResolver(
                    (definition: DefinitionTypeInterface) =>
            ...
            Instance: {
                ...
                actionLogs: this.actionLogsResolverFactory.getListResolver(
                    (instance: InstanceTypeInterface) => ({
            ...
            InstanceActionLog: {
                commandLogs: this.commandLogsResolverFactory.getListResolver(
                    (actionLog: ActionLogTypeInterface) => ({
                        actionLogId: actionLog.id.toString(),
                    }),
                ),
                createdAt: this.dateResolverFactory.getDateResolver(
            ...
            BeforeBuildTask: {
                __resolveType: (
                    beforeBuildTask: BeforeBuildTaskTypeInterface,
                ): string => {
            ...
            AfterBuildTask: {
                __resolveType: (
                    afterBuildTask: AfterBuildTaskTypeInterface,
                ): string => {
