            ...
            volume =>
                new ContextAwareCommand(
                    ...
                    async (
                        ...
                        instantiationContext.mergeEnvVariablesSet(
                            result.envVariables,
                        );
                        instantiationContext.mergeFeaterVariablesSet(
    ...
    protected addParseDockerCompose(
        ...
        createInstanceCommand.addCommand(
            new ContextAwareCommand(
                ...
                () => {
                    const source = instantiationContext.findSource(
                        instantiationContext.composeFiles[0].sourceId,
                    );
            ...
            new ContextAwareCommand(
                ...
                () =>
                    new GetContainerIdsCommand(
                        instantiationContext.composeProjectName,
                        instantiationContext.services.map(service => ({
