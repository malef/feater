...
export class Validator {
    ...
    async validateCreateProjectInputType(
        createProjectInputType: CreateProjectInputTypeInterface,
    ): Promise<any> {
        return await this.validate(
            createProjectInputType,
            createProjectDtoJsonSchema,
        );
    }

    async validateCreateDefinitionInputType(
        createDefinitionInputType: CreateDefinitionInputTypeInterface,
    ): Promise<any> {
        return await this.validate(
            createDefinitionInputType,
            createDefinitionDtoJsonSchema,
        );
    }

    async validateCreateInstanceInputType(
        createInstanceInputType: CreateInstanceInputTypeInterface,
    ): Promise<any> {
        return await this.validate(
            createInstanceInputType,
            createInstanceDtoJsonSchema,
        );
    }
