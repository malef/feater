...
const appRoutes: Routes = [
    ...
    { path: 'instance/:id', component: InstanceDetailSummaryComponent },
    {
        ...
        component: InstanceDetailEnvironmentComponent,
    },
    {
        path: 'instance/:id/services',
        component: InstanceDetailServicesComponent,
    },
    {
        path: 'instance/:id/proxy-domains',
        component: InstanceDetailProxyDomainsComponent,
    },
    {
        path: 'instance/:id/downloads',
        component: InstanceDetailDownloadablesComponent,
    },
